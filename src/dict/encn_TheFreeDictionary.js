...
class encn_TheFreeDictionary {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return 'The Free Dictionary';
        if (locale.indexOf('TW') != -1) return 'The Free Dictionary';
        return 'TheFreeDictionary EN->CN Dictionary';
    }
    ...
    async findTheFreeDictionary(word) {
        ...
        let base = 'https://www.freethesaurus.com/';
